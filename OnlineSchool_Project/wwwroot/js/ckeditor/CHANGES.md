...
* [#1113](https://github.com/ckeditor/ckeditor4/issues/1113): [Firefox] Fixed: Nested contenteditable elements path is not Last updated focus with the [Div Editing Area](https://ckeditor.com/cke4/addon/divarea) plugin.
