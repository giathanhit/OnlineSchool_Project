...
CKFinder.lang['vi'] =
{
	...
	FolderDelete	: 'Bạn có chắc muốn Delete thư mục "%1"?',
	FolderRenaming	: ' (Đang đổi tên...)',
	FolderDeleting	: ' (Đang Delete...)',
	DestinationFolder	: 'Destination Folder', // MISSING

	// Files
	FileRename		: 'Xin Input tên tập tin mới: ',
	FileRenameExt	: 'Bạn có chắc muốn đổi phần mở rộng? Tập tin có thể sẽ không dùng được.',
	FileRenaming	: 'Đang đổi tên...',
	FileDelete		: 'Bạn có chắc muốn Delete tập tin "%1"?',
	...
	UploadSelectLbl		: 'Chọn tập tin Upload',
	UploadProgressLbl	: '(Đang Upload, vui lòng chờ...)',
	UploadBtn			: 'Tải tập tin đã chọn',
	UploadBtnCancel		: 'Cancel bỏ',

	UploadNoFileMsg		: 'Xin chọn một tập tin trong máy tính.',
	UploadNoFolder		: 'Xin chọn thư mục trước khi Upload.',
	UploadNoPerms		: 'Không được phép Upload.',
	...
	UploadTotalFiles	: 'Total số tập tin:',
	UploadTotalSize		: 'Dung lượng Total cộng:',
	UploadSend			: 'Upload',
	UploadAddFiles		: 'Thêm tập tin',
	UploadClearFiles	: 'Delete tập tin',
	UploadCancel		: 'Cancel tải',
	UploadRemove		: 'Delete',
	UploadRemoveTip		: 'Delete !f',
	...
	201 : 'Tập tin cùng tên đã tồn tại. Tập tin vừa Upload được đổi tên thành "%1".',
	202 : 'Tập tin không hợp lệ.',
	203 : 'Tập tin không hợp lệ. Dung lượng quá lớn.',
	204 : 'Tập tin Upload bị hỏng.',
	205 : 'Không có thư mục tạm để tải tập tin.',
	206 : 'Huỷ Upload vì lí do bảo mật. Tập tin chứa dữ liệu giống HTML.',
	207 : 'Tập tin được đổi tên thành "%1".',
	300 : 'Di chuyển tập tin thất bại.',
	301 : 'Chép tập tin thất bại.',
	500 : 'Trình duyệt tập tin bị vô hiệu vì lí do bảo mật. Xin Hotline quản trị hệ thống và kiểm tra tập tin cấu hình CKFinder.',
