...
ALTER TABLE `baihocs`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `IX_BaiHocs_idChuongHoc` (`idChuongHoc`),
  ADD KEY `IX_BaiHocs_idKhoaHoc` (`idKhoaHoc`);
...
ALTER TABLE `chuonghocs`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `IX_ChuongHocs_idKhoaHoc` (`idKhoaHoc`);

--
-- Indexes for table `dangkykhoahocs`
--
ALTER TABLE `dangkykhoahocs`
  ADD KEY `IX_DangKyKhoaHocs_idGiangVien` (`idGiangVien`),
  ADD KEY `IX_DangKyKhoaHocs_idKhoaHoc` (`idKhoaHoc`);
...
ALTER TABLE `danhgiamonhocs`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `IX_DanhGiaMonHocs_idHocVien` (`idHocVien`),
  ADD KEY `IX_DanhGiaMonHocs_idKhoaHoc` (`idKhoaHoc`);
...
ALTER TABLE `giangviens`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `IX_GiangViens_idNganhHoc` (`idNganhHoc`);
...
ALTER TABLE `khoahocs`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `IX_KhoaHocs_idNganhHoc` (`idNganhHoc`);
...
ALTER TABLE `thamgiakhoahocs`
  ADD KEY `IX_ThamGiaKhoaHocs_idHocVien` (`idHocVien`),
  ADD KEY `IX_ThamGiaKhoaHocs_idKhoaHoc` (`idKhoaHoc`);
...
--
ALTER TABLE `baihocs`
  ADD CONSTRAINT `FK_BaiHocs_ChuongHocs_idChuongHoc` FOREIGN KEY (`idChuongHoc`) REFERENCES `chuonghocs` (`Id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_BaiHocs_KhoaHocs_idKhoaHoc` FOREIGN KEY (`idKhoaHoc`) REFERENCES `khoahocs` (`Id`) ON DELETE CASCADE;

--
-- Constraints for table `chuonghocs`
--
ALTER TABLE `chuonghocs`
  ADD CONSTRAINT `FK_ChuongHocs_KhoaHocs_idKhoaHoc` FOREIGN KEY (`idKhoaHoc`) REFERENCES `khoahocs` (`Id`) ON DELETE CASCADE;

--
-- Constraints for table `dangkykhoahocs`
--
ALTER TABLE `dangkykhoahocs`
  ADD CONSTRAINT `FK_DangKyKhoaHocs_GiangViens_idGiangVien` FOREIGN KEY (`idGiangVien`) REFERENCES `giangviens` (`Id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_DangKyKhoaHocs_KhoaHocs_idKhoaHoc` FOREIGN KEY (`idKhoaHoc`) REFERENCES `khoahocs` (`Id`) ON DELETE CASCADE;

--
-- Constraints for table `danhgiamonhocs`
--
ALTER TABLE `danhgiamonhocs`
  ADD CONSTRAINT `FK_DanhGiaMonHocs_HocViens_idHocVien` FOREIGN KEY (`idHocVien`) REFERENCES `hocviens` (`Id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_DanhGiaMonHocs_KhoaHocs_idKhoaHoc` FOREIGN KEY (`idKhoaHoc`) REFERENCES `khoahocs` (`Id`) ON DELETE CASCADE;

--
-- Constraints for table `giangviens`
--
ALTER TABLE `giangviens`
  ADD CONSTRAINT `FK_GiangViens_NganhHocs_idNganhHoc` FOREIGN KEY (`idNganhHoc`) REFERENCES `nganhhocs` (`Id`) ON DELETE CASCADE;

--
-- Constraints for table `khoahocs`
--
ALTER TABLE `khoahocs`
  ADD CONSTRAINT `FK_KhoaHocs_NganhHocs_idNganhHoc` FOREIGN KEY (`idNganhHoc`) REFERENCES `nganhhocs` (`Id`) ON DELETE CASCADE;

--
-- Constraints for table `thamgiakhoahocs`
--
ALTER TABLE `thamgiakhoahocs`
  ADD CONSTRAINT `FK_ThamGiaKhoaHocs_HocViens_idHocVien` FOREIGN KEY (`idHocVien`) REFERENCES `hocviens` (`Id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_ThamGiaKhoaHocs_KhoaHocs_idKhoaHoc` FOREIGN KEY (`idKhoaHoc`) REFERENCES `khoahocs` (`Id`) ON DELETE CASCADE;
COMMIT;
